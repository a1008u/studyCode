...
const writeScreenShot = (data, filename) => {
  let stream = fs.createWriteStream('./capture/test5nesAndeu/' + filename);
...
describe('【localStorageとCookieに未設定かつ[href="./html/bye.html?no=nothing"]】', () => {
  ...
  it('atagの確認(answer1)', () => {
    ...
    element(by.linkText('atagTest1'))
      ...
      .then(targetHref => {
        let exceptHref =
          'https://ja.wikipedia.org/wiki/TypeScript#型アノーテーション';
  ...
  it('atagの確認(answer2)', () => {
    ...
    element(by.linkText('atagTest2'))
      ...
      .then(targetHref => {
        let exceptHref =
          'https://ja.wikipedia.org/wiki/Kotlin?java=kotlin#特徴';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
  ...
  it('atagの確認(answer3)', () => {
    ...
    element(by.linkText('atagTest3'))
      .getAttribute('href')
      .then(targetHref => {
        let exceptHref = 'https://localhost/index.html';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
  ...
  it('atagの確認(answer4)', () => {
    ...
    element(by.linkText('atagTest4'))
      .getAttribute('href')
      .then(targetHref => {
        let exceptHref = 'https://localhost/index.html?tomlike';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
  ...
  it('atagの確認(answer5)', () => {
    ...
    element(by.linkText('atagTest5'))
      .getAttribute('href')
      .then(targetHref => {
        let exceptHref = 'https://localhost/index.html?rrr=test1243';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
  ...
  it('atagの確認(answer6)', () => {
    ...
    element(by.linkText('atagTest6'))
      .getAttribute('href')
      .then(targetHref => {
        let exceptHref = 'https://localhost/index.html#test';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
  ...
  it('atagの確認(answer7)', () => {
    ...
    element(by.linkText('atagTest7'))
      .getAttribute('href')
      .then(targetHref => {
        let exceptHref = 'https://localhost/index.html?te=tetete#test';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
  ...
  it('atagの確認(answer11)', () => {
    ...
    element(by.id('answer11'))
      .getAttribute('href')
      .then(targetHref => {
        let exceptHref = 'https://localhost/img/ts.png';
        expect(unescape(decodeURIComponent(targetHref))).toBe(exceptHref);
