...
const writeScreenShot = (data, filename) => {
  let stream = fs.createWriteStream('./capture/test2nesAndneu/' + filename);
...
describe('【localStorageとCookieに未設定かつ[href="./html/bye.html"]】', () => {
  ...
  // ページ遷移の確認
  let exceptUrl: string = 'https://localhost/html/bye.html';
  let clickId = 'test2';
