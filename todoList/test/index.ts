...
import TodoCollection from '../src/service/todoCollection'
...
describe('Todo Collection', () => {
    ...
    it('should return correct todo model', () => {
        const newTodoCollection = TodoCollection('create app', 'react', 'gym')
        expect(newTodoCollection.get()[1]).to.eql( {id: 1, title: 'react', completed: false} )
    })
    ...
    it('should add todo model', () => {
        ...
        expect(newTodoCollection.get()[0]).to.eql(
            TodoModel(0,'learn new technology',false))
    })
    ...
    it('should toggle todo model', () => {
        ...
        expect(newTodoCollection.get()[0]).to.eql({id: 0, title: 'create app', completed: true})
    })
