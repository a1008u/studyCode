...
fun main(args: Array<String>) {
    ...
    do {
        ...
        for (count in arrayOf(1,2,3)){
            ...
            // fin------------------------------------------------
            if(confirmUserresult(hit, blow, count, answer)) break
        }
...
private fun confirmUserresult(hit: Int, blow:Int, count: Int, answer: Int) : Boolean{
